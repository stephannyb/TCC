...
% --- CORREÇÃO DO LINK DA LISTA DE SIGLAS ---
% Força o hyperref a criar a âncora do link
% junto com o título da lista de siglas, 
% evitando que o link do sumário aponte para a página errada.
\renewcommand{\nompreamble}{%
  \phantomsection%
}
% --- FIM DA CORREÇÃO ---