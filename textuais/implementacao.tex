...
\begin{itemize}
    \item \textbf{dados\_localizacao}: inclui parâmetros como \texttt{tipo\_local}, \texttt{nome\_municipio}, \\ 
    \texttt{sigla\_uf}, \texttt{longitude} e \texttt{latitude}.
    ...
    \item \textbf{dados\_crime}: subdividido em \texttt{violencia\_fisica}, \texttt{violencia\_moral}, \\
    \texttt{violencia\_psicologica}, \texttt{violencia\_sexual}, \texttt{violencia\_patrimonial} e \\ 
    \texttt{feminicidio}, cada qual com indicadores booleanos e registros de data/hora.
\end{itemize}
